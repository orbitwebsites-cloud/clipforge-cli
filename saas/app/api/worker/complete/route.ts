...
const schema = z.object({ jobId: z.string(), workerId: z.string(), clips: z.array(z.object({ title: z.string(), durationSeconds: z.number(), youtubeVideoId: z.string(), youtubeUrl: z.string().url(), privacyStatus: z.enum(['public','private']) })).min(1) });
