  ...
  return (
    <main className="landing-shell">
      ...
      <section className="hero">
        ...
        <p>Connect YouTube and Twitch sources once. ClipForge finds the strongest moments from uploads and stream replays, adds sharp captions, and publishes the Shorts to your YouTube channel. Creator jobs get priority delivery within three hours.</p>
      ...
      <section className="pricing-section" id="pricing">
        ...
        <article className="price-card creator-plan"><div><span className="popular-label"><Zap /> Most popular</span><h3>$49<small>/month</small></h3><div className="annual-offer"><b>$520/year</b><span>Save $68</span></div><p>For creators who want a dependable Shorts engine running every day.</p><ul><li><Check /> 150 published Shorts monthly</li><li><Check /> 5 YouTube or Twitch sources</li><li><Check /> Priority queue with 3-hour target</li><li><Check /> Channel growth and per-Short analytics</li><li><Check /> YouTube uploads + stream replays</li><li><Check /> Twitch VODs after streams end</li><li><Check /> Original audio with burned captions</li><li><Check /> Direct automatic YouTube publishing</li></ul></div><Link className="button button-primary" href="/sign-up">Try Creator Free for 7 Days <ArrowRight size={17} /></Link></article>
      </section>
